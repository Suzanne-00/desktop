 ...
 * @author Usere
 */
public class ViewCustomerGroup extends VBox implements Observable {
    ...
    protected TableView<CustomerGroup> tbl_group;
    ...
    public ViewCustomerGroup() {
        setAppearance();
        setData();
        setActionPerformed();
    }
    
    public ObservableList<CustomerGroup> getSelectedItems() {
    ...
    protected void setActionPerformed() {
        area_header.setButtonSearchActionPerformed(e -> {
                    ...
                    tbl_group.setItems(FXCollections.observableArrayList(CustomerGroup.getGroupsByAttributes(name, note)));
                }
        );
    }
    ...
    protected void setMainArea() {
        setHeaderArea();
        tbl_group = new TableView<CustomerGroup>();
