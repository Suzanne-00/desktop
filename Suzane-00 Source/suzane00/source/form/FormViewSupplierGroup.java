 ...
 * @author Usere
 */
public class FormViewSupplierGroup extends Stage implements Observable{
    ...
    protected ViewSupplierGroup viewGroup;
    protected StandardViewBottomArea area_bottom;
    
    /*------------------------------------------------- END GUI COMPONENTS ------------------------------------------ */
    
    public FormViewSupplierGroup() {
        setAppearance();
        setActionPerformed();
    ...
    protected void setAppearance() {
        viewGroup = new ViewSupplierGroup();
    ...
    protected void setActionPerformed() {        
        ...
        area_bottom.setButtonViewActionPerformed(e -> {
                    SupplierGroup group = viewGroup.getSelectedItems().get(0);
                    FormSupplierGroup form = new FormSupplierGroup(group, FormConstant.MODE_VIEW);
        ...
        area_bottom.setButtonEditActionPerformed(e -> {
                    SupplierGroup group = viewGroup.getSelectedItems().get(0);
                    FormSupplierGroup form = new FormSupplierGroup(group, FormConstant.MODE_EDIT);
        ...
        area_bottom.setButtonDeleteActionPerformed(e -> {
                    ...
                    SupplierGroup.deleteGroup(viewGroup.getSelectedItems().get(0));
