 ...
 * @author Usere
 */
public class FormPickVendorInvoice extends Stage implements Observable{
    
    protected ObservableList<VendorInvoice> v_vendorInvoices ;
    ...
    protected ViewVendorInvoice viewVendorInvoice;
    protected StandardSmallDialogBottomArea area_bottom;
   
    
    /*------------------------------------------------- END GUI COMPONENTS ------------------------------------------ */
    
    public FormPickVendorInvoice() {
        initComponents();
        setAppearance();
        setActionPerformed();
    ...
    public void notifyObservers() {
        ...
        for (Observer observer : v_observers) {
            observer.update(this, viewVendorInvoice.getSelectedItems());
        }
    }
    ...
    protected void setAppearance() {
        setMainArea();
        setTitle("Pick Vendor Invoices");
    }
    
    protected void setActionPerformed() {
        area_bottom.setButtonOkActionPerformed(e -> {
                    v_returnStatus = FormConstant.RETURN_OK;
                    v_vendorInvoices = viewVendorInvoice.getSelectedItems();
                    notifyObservers();
                    close();
                }
    ...
    protected void setMainArea() {
        viewVendorInvoice = new ViewVendorInvoice();
        area_bottom = new StandardSmallDialogBottomArea();
        VBox.setVgrow(viewVendorInvoice, Priority.ALWAYS);
        area_main = new VBox(viewVendorInvoice, area_bottom);
