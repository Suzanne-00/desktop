 ...
 */
@Entity
@Table(name = "vi_misc_charge")
@IdClass(VIMiscChargePK.class)
public class VIMiscCharge implements Serializable, PropertyObject {
    ...
    public VIMiscCharge(VendorInvoice _so, Cost _disc) {
    ...
    public static ObservableList<Cost> convertVIMiscChargesToCosts(List<VIMiscCharge> _miscs) {
    ...
    public void refreshProperty() {
        v_salesInvoiceProperty.setValue(v_vendorInvoice);
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VIMiscCharge)) {
            return false;
        }
        VIMiscCharge other = (VIMiscCharge) object;
