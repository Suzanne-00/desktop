 ...
 */
package suzane00.transaction.view;
 ...
 * @author Usere
 */
public class ViewGenericSimpleObject extends VBox implements Observable {
    ...
    protected StandardViewHeaderArea area_header = new StandardViewHeaderArea();
    protected TableView<Area> tbl_city = new TableView<Area>();
    ...
    public ViewGenericSimpleObject() {
        setAppearance();
        setData();
        setActionPerformed();
    }
    ...
    protected void setActionPerformed() {
        area_header.setButtonSearchActionPerformed(e -> {
                    ...
                    tbl_city.setItems(FXCollections.observableArrayList(Area.getAreasByAttributes(name, note)));
                }
        );
    }
    ...
    protected void configureItemTable() {
        ...
        tbl_city.getColumns().addAll(nameCol, noteCol);
    }
