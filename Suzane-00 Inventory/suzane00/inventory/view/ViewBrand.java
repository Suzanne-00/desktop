 ...
 * @author Usere
 */
public class ViewBrand extends VBox implements Observable {
    ...
    protected TableView<Brand> tbl_brand;
    ...
    public ObservableList<Brand> getSelectedItems() {
        return tbl_brand.getSelectionModel().getSelectedItems();
    }
    ...
    public void notifyObservers() {
        for (Observer observer : m_observers) {
            observer.update(this, tbl_brand.getSelectionModel().getSelectedItem());
        }
    }
    ...
    protected void setActionPerformed() {
        area_header.setButtonSearchActionPerformed(e -> {
                    ...
                    tbl_brand.setItems(FXCollections.observableArrayList(Brand.getBrandsByAttributes(name, note)));
                }
        );
    }
    ...
    protected void setMainArea() {
        setHeaderArea();
        tbl_brand = new TableView<>();
        tbl_brand.setPrefWidth(Utility.STANDARD_TABLE_WIDTH);
        tbl_brand.setPrefHeight(Utility.STANDARD_TABLE_HEIGHT);
        setSpacing(Utility.STANDARD_GAP);
        getChildren().addAll(area_header, tbl_brand);
    }
    ...
    protected void configureItemTable() {
        ...
        tbl_brand.getColumns().addAll(nameCol, noteCol);
    }
