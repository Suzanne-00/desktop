 ...
 * @author Usere
 */
public class ViewArea extends VBox implements Observable {
    ...
    protected TableView<Area> tbl_area;
    ...
    public ObservableList<Area> getSelectedItems() {
        return tbl_area.getSelectionModel().getSelectedItems();
    }
    ...
    public void notifyObservers() {
        for (Observer observer : m_observers) {
            observer.update(this, tbl_area.getSelectionModel().getSelectedItem());
        }
    }
    ...
    protected void setActionPerformed() {
        area_header.setButtonSearchActionPerformed(e -> {
                    ...
                    tbl_area.setItems(FXCollections.observableArrayList(Area.getAreasByAttributes(name, note)));
                }
        );
    }
    ...
    protected void setMainArea() {
        setHeaderArea();
        tbl_area = new TableView<>();
        tbl_area.setPrefWidth(Utility.STANDARD_TABLE_WIDTH);
        tbl_area.setPrefHeight(Utility.STANDARD_TABLE_HEIGHT);
        setSpacing(Utility.STANDARD_GAP);
        getChildren().addAll(area_header, tbl_area);
    }
    ...
    protected void configureItemTable() {
        ...
        tbl_area.getColumns().addAll(nameCol, noteCol);
    }
