 ...
 * @author Usere
 */
public class ViewSellPriceType extends VBox implements Observable {
    ...
    protected TableView<SellPriceType> tbl_priceType;
    ...
    public ViewSellPriceType() {
        setAppearance();
        setData();
        setActionPerformed();
    }
    
    public ObservableList<SellPriceType> getSelectedItems() {
        return tbl_priceType.getSelectionModel().getSelectedItems();
    }
    
    public TableView getTable() {
        return tbl_priceType;
    }
    ...
    public void notifyObservers() {
        for (Observer observer : m_observers) {
            observer.update(this, tbl_priceType.getSelectionModel().getSelectedItem());
        }
    }
    ...
    protected void setActionPerformed() {
        area_header.setButtonSearchActionPerformed(e -> {
                    ...
                    tbl_priceType.setItems(FXCollections.observableArrayList(SellPriceType.getPriceTypesByAttributes(name, note)));
                }
        );
    }
    ...
    protected void setMainArea() {
        setHeaderArea();
        tbl_priceType = new TableView<>();
        tbl_priceType.setPrefWidth(Utility.STANDARD_TABLE_WIDTH);
        tbl_priceType.setPrefHeight(Utility.STANDARD_TABLE_HEIGHT);
        setSpacing(Utility.STANDARD_GAP);
        getChildren().addAll(area_header, tbl_priceType);
    }
    ...
    protected void configureItemTable() {
        ...
        tbl_priceType.getColumns().addAll(nameCol, noteCol);
    }
