 ...
 */
@Entity
@Table(name = "so_discount")
@IdClass(SODiscountPK.class)
public class SODiscount implements Serializable, PropertyObject {
...
//    public static final String TYPE_VALUE = "Value";           
    ...
    public SODiscount(SalesOrder _so, Cost _disc) {
        setSalesOrder(_so);
    ...
    public static ObservableList<Cost> convertSODiscountsToCosts(List<SODiscount> _discs) {
        ObservableList<Cost> costs = FXCollections.observableArrayList();
        for (SODiscount _disc : _discs) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SODiscount)) {
            return false;
        }
        SODiscount other = (SODiscount) object;
