 ...
 * @author Usere
 */
public class FormPickSalesOrder extends Stage implements Observable{
    
    protected ObservableList<SalesOrder> v_salesOrders ;
    ...
    protected ViewSalesOrder viewSalesOrder;
    protected StandardSmallDialogBottomArea area_bottom;
   
    
    /*------------------------------------------------- END GUI COMPONENTS ------------------------------------------ */
    
    public FormPickSalesOrder() {
        initComponents();
        setAppearance();
        setActionPerformed();
    ...
    public void notifyObservers() {
        ...
        for (Observer observer : v_observers) {
            observer.update(this, viewSalesOrder.getSelectedItems());
        }
    }
    ...
    protected void setActionPerformed() {
        area_bottom.setButtonOkActionPerformed(
                e -> {
                    v_returnStatus = FormConstant.RETURN_OK;
                    v_salesOrders = viewSalesOrder.getSelectedItems();
                    notifyObservers();
                    close();
                }
    ...
    protected void setMainArea() {
        viewSalesOrder = new ViewSalesOrder();
        area_bottom = new StandardSmallDialogBottomArea();
        VBox.setVgrow(viewSalesOrder, Priority.ALWAYS);
        area_main = new VBox(viewSalesOrder, area_bottom);
