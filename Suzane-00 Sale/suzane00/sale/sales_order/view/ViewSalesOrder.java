 ...
 */
package suzane00.sale.sales_order.view;
 ...
 * @author Usere
 */
public class ViewSalesOrder extends VBox implements Observable {
    ...
    protected TableView<SalesOrder> tbl_so;
    ...
    public ObservableList<SalesOrder> getSelectedItems() {
        return tbl_so.getSelectionModel().getSelectedItems();
    }
    ...
    public void notifyObservers() {
        for (Observer observer : m_observers) {
            observer.update(this, tbl_so.getSelectionModel().getSelectedItems());
        }
    }
    ...
    protected  void setActionPerformed() {
        area_header.setButtonSearchActionPerformed(e -> {
                    ...
                    String custPO = txt_customerPO.getText();
                    Customer customer = (Customer) cmb_customer.getValue();
...
//                    }
                    ...
                    tbl_so.setItems(
                        SalesOrder.getSOSByAttributes(
                                num, custPO, customer, note, issueFrom, issueTo, dueFrom, dueTo)
                    );
                }
        );
    }
    ...
    protected void setMainArea() {
        ...
        tbl_so = new TableView<>();
        tbl_so.setPrefWidth(Utility.STANDARD_TABLE_WIDTH);
        tbl_so.setPrefHeight(Utility.STANDARD_TABLE_HEIGHT);
        setVgrow(tbl_so, Priority.ALWAYS);
        setSpacing(Utility.STANDARD_GAP);
        getChildren().addAll(area_header, tbl_so);
    }
    ...
    protected void setLeftHeaderArea() {
        ...
        lbl_customerPO = new Label("Customer PO:: ");
        ...
        txt_customerPO.setPrefWidth(Utility.STANDARD_TEXT_WIDTH);
        ...
        area_leftHeader.add(lbl_soNumber, 0, 0);
        area_leftHeader.add(txt_poNumber, 1, 0);
        area_leftHeader.add(lbl_customerPO, 0, 1);
        area_leftHeader.add(txt_customerPO, 1, 1);
    ...
    protected void configureTable() {
        ...
        tbl_so.getColumns().addAll(poNumbCol, supplierCol, noteCol, 
                                      issueDateCol, dueDateCol);
    }
    
    protected void loadComboCustomer() {
