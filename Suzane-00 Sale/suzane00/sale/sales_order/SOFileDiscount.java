 ...
 */
@Entity
@Table(name = "so_file_discount")
@IdClass(SOFileDiscountPK.class)
public class SOFileDiscount implements Serializable {
...
//    public static final String TYPE_VALUE = "Value";           
    ...
    public SOFileDiscount() {
        
    }
    
    public SOFileDiscount(SOFile _file, Cost _disc) {
        setFile(_file);
    ...
    public static ObservableList<Cost> convertSOFileDiscountsToCosts(List<SOFileDiscount> _discs) {
        ObservableList<Cost> costs = FXCollections.observableArrayList();
        for (SOFileDiscount _disc : _discs) {
    ...
    public SOFile getPoFile() {
        return v_file;
    }

    public void setFile(SOFile _file) {
        this.v_file = _file;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SOFileDiscount)) {
            return false;
        }
        SOFileDiscount other = (SOFileDiscount) object;
