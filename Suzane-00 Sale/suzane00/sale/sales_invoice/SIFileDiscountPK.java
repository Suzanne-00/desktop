 ...
 * @author Usere
 */
public class SIFileDiscountPK {
    
    private SIFilePK v_file ;
    private String v_name ;
    
    public SIFilePK getFile ()
    {
        return v_file;
    }

    public void setFile (SIFilePK _file)
    {
        this.v_file = _file;
    }
    ...
    public boolean equals (Object object)
    {
        ...
        if (!(object instanceof SIFileDiscountPK)) {
            return false;
        }
        
        SIFileDiscountPK other = (SIFileDiscountPK) object;
