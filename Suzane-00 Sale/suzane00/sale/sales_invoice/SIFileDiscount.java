 ...
 */
@Entity
@Table(name = "si_file_discount")
@IdClass(SIFileDiscountPK.class)
public class SIFileDiscount implements Serializable {
...
//    public static final String TYPE_VALUE = "Value";           
    ...
    @ManyToOne
    @JoinColumns({
        @JoinColumn(name = "si_id", referencedColumnName = "si_id"),
        @JoinColumn(name = "item_id", referencedColumnName = "item_id"),
        @JoinColumn(name = "unit_id", referencedColumnName = "unit_id") })
    private SIFile v_file; 
    @Transient
    ...
    public SIFileDiscount() {
        
    }
    
    public SIFileDiscount(SIFile _file, Cost _disc) {
        setFile(_file);
    ...
    public static ObservableList<Cost> convertSOFileDiscountsToCosts(List<SIFileDiscount> _discs) {
        ObservableList<Cost> costs = FXCollections.observableArrayList();
        for (SIFileDiscount _disc : _discs) {
    ...
    public void setFile(SIFile _file) {
        this.v_file = _file;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SIFileDiscount)) {
            return false;
        }
        SIFileDiscount other = (SIFileDiscount) object;
