 ...
 * @author Usere
 */
public class FormPickTransferStock extends Stage implements Observable{
    
    protected ObservableList<TransferStock> v_transferStock ;
    ...
    protected void setActionPerformed() {
        area_bottom.setButtonOkActionPerformed(e -> {
                    v_returnStatus = FormConstant.RETURN_OK;
                    v_transferStock = viewTransferStock.getSelectedItems();
                    notifyObservers();
                    close();
                }
